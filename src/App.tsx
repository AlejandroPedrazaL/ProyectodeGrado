...
const uiProviders = [new ViewAttributesWidgetProvider(), new IssuesWidgetProvider()];

const App: React.FC = () => {
  const [iModelId, setIModelId] = useState(process.env.IMJS_IMODEL_ID);
  const [iTwinId, setITwinId] = useState(process.env.IMJS_ITWIN_ID);

  const [openDescarga, setDescarga] = useState(false);
  const [openCarga, setCarga] = useState(false);
